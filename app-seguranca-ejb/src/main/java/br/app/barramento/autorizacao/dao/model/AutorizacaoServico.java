...
@Entity
@XmlRootElement
@Table(name = "autorizacaoservico")
public class AutorizacaoServico implements Entidade, Serializable {
	...
	public Long getIdCatalago() {
		return idCatalago;
	}

	public void setIdCatalago(Long idCatalago) {
